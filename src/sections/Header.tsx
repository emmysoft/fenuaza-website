...
const Header = () => {
  return (
    ...
    }} className='flex-col md:flex-row bg-gradient-to-r from-[#1E0D37] to-purple-800 flex min-h-[100vh] h-max overflow-y-auto mt-[70px]'>
        <div className="flex-1 flex flex-col justify-center gap-4 md:gap-7 py-3 px-6 mx-auto">
          ...
          <div className="flex items-center bg-White text-Blue gap-2 py-3 px-6 rounded-md shadow-sm cursor-pointer hover:scale-125 justify-start w-max">
